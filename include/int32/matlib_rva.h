...
int maxcoeff_rva(int **a, int n, int m);
int mincoeff_rva(int **a, int n, int m);
int matnorm_rva(int **a, int n, int m);
void matneg_rva(int **a, int **b, int n, int m);
void cwiseabs_rva(int **a, int **b, int n, int m);
void cwisemin_rva(int **a, int **b, int **c, int n, int m);
...
void matsub_rva(int **a, int **b, int **c, int n, int m);
void matadd_rva(int **a, int **b, int **c, int n, int m);
void transpose_rva(int **a, int **b, int n, int m);
void matcopy_rva(int **a, int **b, int n, int m);
void matset_rva(int **a, int f, int n, int m);
void matsetv_rva(int **a, int *f, int n, int m);
...
inline int maxcoeff_rva(int **a, int n, int m) {
    return maxcoeff_rvv(a[0], n, m);
}

// matrix min coefficient
inline int mincoeff_rva(int **a, int n, int m) {
    return mincoeff_rvv(a[0], n, m);
}

// matrix unary negative
inline void matneg_rva(int **a, int **b, int n, int m) {
    matneg_rvv(a[0], b[0], n, m);
}

// matrix coefficient-wise abs
inline void cwiseabs_rva(int **a, int **b, int n, int m) {
    cwiseabs_rvv(a[0], b[0], n, m);
}

// matrix coefficient-wise min
inline void cwisemin_rva(int **a, int **b, int **c, int n, int m) {
    cwisemin_rvv(a[0], b[0], c[0], n, m);
}

// matrix coefficient-wise multiplication
inline void cwisemul_rva(int **a, int **b, int **c, int n, int m) {
    cwisemul_rvv(a[0], b[0], c[0], n, m);
}

// matrix coefficient-wise max
inline void cwisemax_rva(int **a, int **b, int **c, int n, int m) {
 ...
 *                4
 */
inline void matvec_rva(int **a, int **b, int **c, int n, int m) {
 ...
 *              4 8 6
 */
inline void matvec_transpose_rva(int **a, int **b, int **c, int n, int m) {
    matvec_transpose_rvv(a[0], b[0], c[0], n, m);
}

// matrix scalar multiplication
inline void matmulf_rva(int **a, int **b, int f, int n, int m) {
    matmulf_rvv(a[0], b[0], f, n, m);
}

// matrix subtraction
inline void matsub_rva(int **a, int **b, int **c, int n, int m) {
    matsub_rvv(a[0], b[0], c[0], n, m);
}

// matrix addition
inline void matadd_rva(int **a, int **b, int **c, int n, int m) {
    matsub_rvv(a[0], b[0], c[0], n, m);
}

// matrix transpose
inline void transpose_rva(int **a, int **b, int n, int m) {
    transpose_rvv(a[0], b[0], n, m);
};

// matrix copy
inline void matcopy_rva(int **a, int **b, int n, int m) {
    matcopy_rvv((const int *)(a[0]), b[0], n, m);
}

inline void matset_rva(int **a, int f, int n, int m) {
    matset_rvv(a[0], f, n, m);
}

inline void matsetv_rva(int **a, int *f, int n, int m) {
    matsetv_rvv(a[0], f, n, m);
}

// matrix l2 norm
inline int matnorm_rva(int **a, int n, int m) {
